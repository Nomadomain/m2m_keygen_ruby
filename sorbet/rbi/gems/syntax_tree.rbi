...
class SyntaxTree::Formatter < PrettierPrint
  ...
  def initialize(source, *args, quote: nil, trailing_comma: nil, target_ruby_version: nil); end
  def parent; end
  def parents; end
  def quote; end
  def self.format(source, node); end
  def source; end
  def stack; end
...
class SyntaxTree::BEGINBlock < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(lbrace:, statements:, location:, comments: nil); end
  def lbrace; end
  def statements; end
end
class SyntaxTree::CHAR < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(value:, location:, comments: nil); end
  def value; end
end
...
class SyntaxTree::Alias < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(left:, right:, location:, comments: nil); end
  def left; end
  def right; end
end
...
class SyntaxTree::ARef < SyntaxTree::Node
  ...
  def format(q); end
  def index; end
  def initialize(collection:, index:, location:, comments: nil); end
end
...
class SyntaxTree::ArgParen < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(arguments:, location:, comments: nil); end
  def trailing_comma?; end
end
class SyntaxTree::Args < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(parts:, location:, comments: nil); end
  def parts; end
end
...
class SyntaxTree::ArrayLiteral < SyntaxTree::Node
  ...
  def format(q); end
  def initialize(lbracket:, contents:, location:, comments: nil); end
  def lbracket; end
  def qsymbols?; end
  def qwords?; end
  def var_refs?(q); end
...
class SyntaxTree::AryPtn < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(constant:, requireds:, rest:, posts:, location:, comments: nil); end
  def posts; end
  def requireds; end
  def rest; end
end
...
class SyntaxTree::Assign < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(target:, value:, location:, comments: nil); end
  def skip_indent?; end
  def target; end
  def value; end
end
class SyntaxTree::Assoc < SyntaxTree::Node
  ...
  def initialize(key:, value:, location:, comments: nil); end
  def key; end
  def value; end
end
...
class SyntaxTree::BareAssocHash < SyntaxTree::Node
  ...
  def format(q); end
  def format_key(q, key); end
  def initialize(assocs:, location:, comments: nil); end
end
class SyntaxTree::Begin < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(bodystmt:, location:, comments: nil); end
end
class SyntaxTree::PinnedBegin < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(statement:, location:, comments: nil); end
  def statement; end
end
class SyntaxTree::Binary < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(left:, operator:, right:, location:, comments: nil); end
  def left; end
  def operator; end
  def right; end
end
class SyntaxTree::BlockVar < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(params:, locals:, location:, comments: nil); end
  def locals; end
  def params; end
end
class SyntaxTree::BlockArg < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(name:, location:, comments: nil); end
  def name; end
end
class SyntaxTree::BodyStmt < SyntaxTree::Node
  ...
  def format(q); end
  def initialize(statements:, rescue_clause:, else_keyword:, else_clause:, ensure_clause:, location:, comments: nil); end
...
class SyntaxTree::BraceBlock < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(lbrace:, block_var:, statements:, location:, comments: nil); end
  def lbrace; end
  def statements; end
end
...
class SyntaxTree::Call < SyntaxTree::Node
  ...
  def format_contents(q); end
  def initialize(receiver:, operator:, message:, arguments:, location:, comments: nil); end
  def message; end
  def operator; end
  def receiver; end
end
class SyntaxTree::Case < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(keyword:, value:, consequent:, location:, comments: nil); end
  def keyword; end
  def value; end
end
class SyntaxTree::RAssign < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(value:, operator:, pattern:, location:, comments: nil); end
  def operator; end
  def pattern; end
  def value; end
end
class SyntaxTree::ClassDeclaration < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(constant:, superclass:, bodystmt:, location:, comments: nil); end
  def superclass; end
end
...
class SyntaxTree::Command < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(message:, arguments:, location:, comments: nil); end
  def message; end
end
...
class SyntaxTree::ConstPathField < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(parent:, constant:, location:, comments: nil); end
  def parent; end
end
...
class SyntaxTree::ConstRef < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(constant:, location:, comments: nil); end
end
...
class SyntaxTree::Def < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(name:, params:, bodystmt:, location:, comments: nil); end
  def name; end
  def params; end
end
class SyntaxTree::DefEndless < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(target:, operator:, name:, paren:, statement:, location:, comments: nil); end
  def name; end
  def operator; end
  def paren; end
  def statement; end
...
class SyntaxTree::Defs < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(target:, operator:, name:, params:, bodystmt:, location:, comments: nil); end
  def name; end
  def operator; end
  def params; end
  def target; end
...
class SyntaxTree::DoBlock < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(keyword:, block_var:, bodystmt:, location:, comments: nil); end
  def keyword; end
end
...
class SyntaxTree::DynaSymbol < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(parts:, quote:, location:, comments: nil); end
  def parts; end
  def quote; end
  def quotes(q); end
end
class SyntaxTree::Else < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(keyword:, statements:, location:, comments: nil); end
  def keyword; end
  def statements; end
end
class SyntaxTree::Elsif < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(predicate:, statements:, consequent:, location:, comments: nil); end
  def predicate; end
  def statements; end
end
...
class SyntaxTree::FCall < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(value:, arguments:, location:, comments: nil); end
  def value; end
end
class SyntaxTree::Field < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(parent:, operator:, name:, location:, comments: nil); end
  def name; end
  def operator; end
  def parent; end
end
...
class SyntaxTree::FndPtn < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(constant:, left:, values:, right:, location:, comments: nil); end
  def left; end
  def right; end
  def values; end
end
class SyntaxTree::For < SyntaxTree::Node
  ...
  def format(q); end
  def index; end
  def initialize(index:, collection:, statements:, location:, comments: nil); end
  def statements; end
end
...
class SyntaxTree::HashLiteral < SyntaxTree::Node
  ...
  def format_contents(q); end
  def format_key(q, key); end
  def initialize(lbrace:, assocs:, location:, comments: nil); end
  def lbrace; end
end
...
class SyntaxTree::Heredoc < SyntaxTree::Node
  ...
  def ending; end
  def format(q); end
  def initialize(beginning:, location:, ending: nil, dedent: nil, parts: nil, comments: nil); end
  def parts; end
end
...
class SyntaxTree::HshPtn < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(constant:, keywords:, keyword_rest:, location:, comments: nil); end
...
class SyntaxTree::IfOp < SyntaxTree::Node
  ...
  def initialize(predicate:, truthy:, falsy:, location:, comments: nil); end
  def predicate; end
  def truthy; end
end
...
class SyntaxTree::IfMod < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(statement:, predicate:, location:, comments: nil); end
  def predicate; end
  def statement; end
end
...
class SyntaxTree::In < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(pattern:, statements:, consequent:, location:, comments: nil); end
  def pattern; end
  def statements; end
end
...
class SyntaxTree::Lambda < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(params:, statements:, location:, comments: nil); end
  def params; end
  def statements; end
end
...
class SyntaxTree::MethodAddBlock < SyntaxTree::Node
  ...
  def format(q); end
  def format_contents(q); end
  def initialize(call:, block:, location:, comments: nil); end
end
class SyntaxTree::MLHS < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(parts:, location:, comma: nil, comments: nil); end
  def parts; end
end
class SyntaxTree::MLHSParen < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(contents:, location:, comma: nil, comments: nil); end
end
class SyntaxTree::ModuleDeclaration < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(constant:, bodystmt:, location:, comments: nil); end
end
...
class SyntaxTree::OpAssign < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(target:, operator:, value:, location:, comments: nil); end
  def operator; end
  def skip_indent?; end
  def target; end
  def value; end
...
class SyntaxTree::Params < SyntaxTree::Node
  ...
  def empty?; end
  def format(q); end
  def initialize(location:, requireds: nil, optionals: nil, rest: nil, posts: nil, keywords: nil, keyword_rest: nil, block: nil, comments: nil); end
  def keyword_rest; end
  def keywords; end
  def optionals; end
  def posts; end
...
class SyntaxTree::Paren < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(lparen:, contents:, location:, comments: nil); end
  def lparen; end
end
...
class SyntaxTree::Program < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(statements:, location:, comments: nil); end
  def statements; end
end
class SyntaxTree::QSymbols < SyntaxTree::Node
  ...
  def elements; end
  def format(q); end
  def initialize(beginning:, elements:, location:, comments: nil); end
end
...
class SyntaxTree::RegexpLiteral < SyntaxTree::Node
  ...
  def initialize(beginning:, ending:, parts:, location:, comments: nil); end
  def options; end
  def parts; end
end
class SyntaxTree::RescueEx < SyntaxTree::Node
  ...
  def exceptions; end
  def format(q); end
  def initialize(exceptions:, variable:, location:, comments: nil); end
  def variable; end
end
class SyntaxTree::Rescue < SyntaxTree::Node
  ...
  def exception; end
  def format(q); end
  def initialize(keyword:, exception:, statements:, consequent:, location:, comments: nil); end
  def keyword; end
  def statements; end
end
class SyntaxTree::RescueMod < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(statement:, value:, location:, comments: nil); end
  def statement; end
  def value; end
end
...
class SyntaxTree::SClass < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(target:, bodystmt:, location:, comments: nil); end
  def target; end
end
class SyntaxTree::Statements < SyntaxTree::Node
  ...
  def empty?; end
  def format(q); end
  def initialize(parser, body:, location:, comments: nil); end
  def parser; end
end
...
class SyntaxTree::StringDVar < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(variable:, location:, comments: nil); end
  def variable; end
end
...
class SyntaxTree::Not < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(statement:, parentheses:, location:, comments: nil); end
  def parentheses; end
  def statement; end
end
class SyntaxTree::Unary < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(operator:, statement:, location:, comments: nil); end
  def operator; end
  def statement; end
end
class SyntaxTree::Undef < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(symbols:, location:, comments: nil); end
  def symbols; end
end
...
class SyntaxTree::Until < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(predicate:, statements:, location:, comments: nil); end
  def predicate; end
  def statements; end
end
...
class SyntaxTree::VoidStmt < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(location:, comments: nil); end
  def location; end
end
class SyntaxTree::When < SyntaxTree::Node
  ...
  def deconstruct_keys(_keys); end
  def format(q); end
  def initialize(arguments:, statements:, consequent:, location:, comments: nil); end
  def statements; end
end
...
class SyntaxTree::Parser < Ripper
  ...
  def find_token(type, value = nil, consume: nil, location: nil); end
  def find_token_error(location); end
  def initialize(source, *arg1); end
  ...
  def on_alias_error(error, *arg1); end
  ...
  def on_assign_error(error, *arg1); end
  ...
  def on_class_name_error(error, *arg1); end
  ...
  def on_excessed_comma(*arg0); end
