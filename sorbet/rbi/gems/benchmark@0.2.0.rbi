...
module Benchmark
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:168
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:207
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:249
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:294
  def measure(label = T.unsafe(nil)); end

  # Returns the elapsed real time used to execute the given block.
  #
  # source://RUBY_ROOT/benchmark.rb:309
  def realtime; end
...
class Benchmark::Job
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:329
  ...
  # @raise [ArgumentError]
  #
  # source://RUBY_ROOT/benchmark.rb:337
  def item(label = T.unsafe(nil), &blk); end

  # An array of 2-element arrays, consisting of label and block pairs.
  #
  # source://RUBY_ROOT/benchmark.rb:349
  def list; end
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:352
  def width; end
end
...
class Benchmark::Report
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:367
  ...
  # formatting rules.
  #
  # source://RUBY_ROOT/benchmark.rb:376
  def item(label = T.unsafe(nil), *format, &blk); end

  # An array of Benchmark::Tms objects representing each item.
  #
  # source://RUBY_ROOT/benchmark.rb:386
  def list; end
...
class Benchmark::Tms
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:430
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:478
  def *(x); end
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:465
  def +(other); end
  ...
  # Tms object.
  #
  # source://RUBY_ROOT/benchmark.rb:472
  def -(other); end
  ...
  # This method and #+() are useful for taking statistics.
  #
  # source://RUBY_ROOT/benchmark.rb:485
  def /(x); end

  # Returns a new Tms object whose times are the sum of the times for this
  # Tms object, plus the time required to execute the code block (+blk+).
  #
  # source://RUBY_ROOT/benchmark.rb:439
  def add(&blk); end
  ...
  # the code block (+blk+).
  #
  # source://RUBY_ROOT/benchmark.rb:449
  def add!(&blk); end

  # System CPU time of children
  #
  # source://RUBY_ROOT/benchmark.rb:413
  def cstime; end

  # User CPU time of children
  #
  # source://RUBY_ROOT/benchmark.rb:410
  def cutime; end
  ...
  #
  # source://RUBY_ROOT/benchmark.rb:504
  def format(format = T.unsafe(nil), *args); end

  # Label
  #
  # source://RUBY_ROOT/benchmark.rb:422
  def label; end

  # Elapsed real time
  #
  # source://RUBY_ROOT/benchmark.rb:416
  def real; end

  # System CPU time
  #
  # source://RUBY_ROOT/benchmark.rb:407
  def stime; end
  ...
  # real time.
  #
  # source://RUBY_ROOT/benchmark.rb:529
  def to_a; end

  # Returns a hash containing the same data as `to_a`.
  #
  # source://RUBY_ROOT/benchmark.rb:536
  def to_h; end

  # Same as #format.
  #
  # source://RUBY_ROOT/benchmark.rb:519
  def to_s; end

  # Total time, that is +utime+ + +stime+ + +cutime+ + +cstime+
  #
  # source://RUBY_ROOT/benchmark.rb:419
  def total; end

  # User CPU time
  #
  # source://RUBY_ROOT/benchmark.rb:404
  def utime; end
  ...
  # <tt>*</tt>, <tt>/</tt>
  #
  # source://RUBY_ROOT/benchmark.rb:557
