...
class RBS::EnvironmentLoader
  def add(path: nil, library: nil, version: nil); end
...
class RBS::Parser
  def self._parse_method_type(arg0, arg1, arg2, arg3); end
  def self._parse_signature(arg0, arg1, arg2); end
  def self._parse_type(arg0, arg1, arg2, arg3); end
  def self.buffer(source); end
  def self.parse_method_type(source, line: nil, column: nil, variables: nil); end
  def self.parse_signature(source, line: nil, column: nil); end
  def self.parse_type(source, line: nil, column: nil, variables: nil); end
end
