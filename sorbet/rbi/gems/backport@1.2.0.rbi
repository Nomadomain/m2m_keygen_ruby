...
#
# source://backport-1.2.0/lib/backport/version.rb:1
module Backport
  class << self
    # @return [Logger]
    #
    # source://backport-1.2.0/lib/backport.rb:75
    def logger; end
    ...
    # @return [void]
    #
    # source://backport-1.2.0/lib/backport.rb:35
    ...
    # @return [void]
    #
    # source://backport-1.2.0/lib/backport.rb:17
    ...
    # @return [void]
    #
    # source://backport-1.2.0/lib/backport.rb:27
    ...
    # @return [void]
    #
    # source://backport-1.2.0/lib/backport.rb:50
    def run(&block); end
    ...
    # @return [void]
    #
    # source://backport-1.2.0/lib/backport.rb:70
    def stop; end
    ...
    #
    # source://backport-1.2.0/lib/backport.rb:82
    def machines; end
  end
end
...
#
# source://backport-1.2.0/lib/backport/adapter.rb:4
class Backport::Adapter
  # @param output [IO]
  # @param remote [Hash{Symbol => String, Integer}]
  # @return [Adapter] a new instance of Adapter
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:7
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:80
  def close; end

  # @return [Boolean]
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:69
  def closed?; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:41
  def closing; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:34
  def opening; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:49
  ...
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:25
  def remote; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:55
  def write(data); end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/adapter.rb:64
  def write_line(data); end
end

# A client connected to a connectable Backport server.
#
# source://backport-1.2.0/lib/backport/client.rb:6
class Backport::Client
  ...
  #
  # source://backport-1.2.0/lib/backport/client.rb:16
  def initialize(input, output, adapter, remote = T.unsafe(nil)); end

  # @return [Adapter]
  #
  # source://backport-1.2.0/lib/backport/client.rb:10
  def adapter; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/client.rb:50
  def run; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/client.rb:38
  def stop; end
  ...
  # @return [Boolean]
  #
  # source://backport-1.2.0/lib/backport/client.rb:27
  def stopped?; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/client.rb:64
  def tick; end
  ...
  # @return [Adapter]
  #
  # source://backport-1.2.0/lib/backport/client.rb:86
  def make_adapter(mod_cls, remote); end

  # @return [Mutex]
  #
  # source://backport-1.2.0/lib/backport/client.rb:98
  def mutex; end
  ...
  # @return [String, nil]
  #
  # source://backport-1.2.0/lib/backport/client.rb:74
  def read; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/client.rb:112
  def read_input; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/client.rb:103
  def run_input_thread; end
end

# The Backport server controller.
#
# source://backport-1.2.0/lib/backport/machine.rb:4
class Backport::Machine
  # @return [Machine] a new instance of Machine
  #
  # source://backport-1.2.0/lib/backport/machine.rb:5
  def initialize; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/machine.rb:45
  ...
  # @yieldparam [self]
  #
  # source://backport-1.2.0/lib/backport/machine.rb:16
  def run; end

  # @return [Array<Server::Base>]
  #
  # source://backport-1.2.0/lib/backport/machine.rb:52
  def servers; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/machine.rb:27
  def stop; end
  ...
  # @return [Boolean]
  #
  # source://backport-1.2.0/lib/backport/machine.rb:35
  def stopped?; end

  # @param server [Server::Base]
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/machine.rb:58
  ...
  # @return [Mutex]
  #
  # source://backport-1.2.0/lib/backport/machine.rb:70
  def mutex; end
...
class Backport::Server::Base
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/base.rb:14
  def start; end

  # @return [Boolean]
  #
  # source://backport-1.2.0/lib/backport/server/base.rb:31
  def started?; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/base.rb:44
  def starting; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/base.rb:23
  def stop; end

  # @return [Boolean]
  #
  # source://backport-1.2.0/lib/backport/server/base.rb:35
  def stopped?; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/base.rb:50
  def stopping; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/base.rb:57
  def tick; end
end
...
#
# source://backport-1.2.0/lib/backport/server/connectable.rb:7
module Backport::Server::Connectable
  # @return [Array<Client>]
  #
  # source://backport-1.2.0/lib/backport/server/connectable.rb:19
  def clients; end

  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/connectable.rb:9
  def starting; end

  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/connectable.rb:14
  def stopping; end
  ...
  # @return [Mutex]
  #
  # source://backport-1.2.0/lib/backport/server/connectable.rb:26
  def mutex; end
end

# A Backport periodical interval server.
#
# source://backport-1.2.0/lib/backport/server/interval.rb:8
class Backport::Server::Interval < ::Backport::Server::Base
  ...
  # @yieldparam [Interval]
  #
  # source://backport-1.2.0/lib/backport/server/interval.rb:9
  def initialize(period, &block); end

  # source://backport-1.2.0/lib/backport/server/interval.rb:16
  def starting; end

  # source://backport-1.2.0/lib/backport/server/interval.rb:21
  def tick; end
  ...
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/interval.rb:32
  def run_ready_thread; end
end

# A Backport STDIO server.
#
# source://backport-1.2.0/lib/backport/server/stdio.rb:5
class Backport::Server::Stdio < ::Backport::Server::Base
  ...
  #
  # source://backport-1.2.0/lib/backport/server/stdio.rb:11
  def initialize(input: T.unsafe(nil), output: T.unsafe(nil), adapter: T.unsafe(nil)); end

  # @param client [Client]
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/stdio.rb:22
...
#
# source://backport-1.2.0/lib/backport/server/tcpip.rb:8
class Backport::Server::Tcpip < ::Backport::Server::Base
  ...
  #
  # source://backport-1.2.0/lib/backport/server/tcpip.rb:15
  ...
  # @return [Client, nil]
  #
  # source://backport-1.2.0/lib/backport/server/tcpip.rb:41
  def accept; end

  # source://backport-1.2.0/lib/backport/server/tcpip.rb:21
  def starting; end

  # source://backport-1.2.0/lib/backport/server/tcpip.rb:25
  def stopping; end

  # @param client [Client]
  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/tcpip.rb:78
  def update(client); end
  ...
  # @return [TCPSocket]
  #
  # source://backport-1.2.0/lib/backport/server/tcpip.rb:89
  def socket; end

  # @return [void]
  #
  # source://backport-1.2.0/lib/backport/server/tcpip.rb:92
  def start_accept_thread; end
end

# source://backport-1.2.0/lib/backport/version.rb:2
