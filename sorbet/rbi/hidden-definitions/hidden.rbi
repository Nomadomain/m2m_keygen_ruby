...
class PrettierPrint::IndentLevel
  DedentPart = ::T.let(nil, ::T.untyped)
  IndentPart = ::T.let(nil, ::T.untyped)
end
...
module RspecInContext::InContext
  GLOBAL_CONTEXT = ::T.let(nil, ::T.untyped)
end
...
module SyntaxTree::Haml
  DOCTYPE_TYPES = ::T.let(nil, ::T.untyped)
  DOCTYPE_VERSIONS = ::T.let(nil, ::T.untyped)
end
